  ...
  return(
    <div className="w-full max-h-screen p-3 bg-Blue flex gap-3 box-border">
      <div className="w-fit flex flex-col gap-3">
        ...
        <Button color="warning" size="w-full" handleClick={changeOpenEncerramento}>
          ENCERRAR PROVA
        </Button>
      </div>
      <div className="w-full max-h-screen py-8 bg-White rounded-xl box-border">
        <ul className="max-h-full px-8 flex flex-col gap-9 overflow-auto">
          <Question.Root>
            ...
            <Question.Alternative label="enumerações para sustentar o ponto de vista apresentado." id="1" name="question"/>
            <Question.Alternative label="exemplificações para ilustrar a distinção entre a música e outros sons cotidianos." id="2" name="question"/>
            <Question.Alternative label="generalizações para sintetizar as diversas percepções sobre o que é a música." id="3" name="question"/>
            <Question.Alternative label="adjetivações para descrever os tipos de música." id="4" name="question"/>
            <Question.Alternative label="sinonímias para retomar as características das obras musicais." id="5" name="question"/>
          </Question.Root>
          <Question.Root>
            <Question.Title text="Questão - 1"/>
            <Question.Text title="O que é música? " text="A pergunta “o que é música” tem sido alvo de discussão há décadas. Alguns autores defendem que música é a combinação de sons e silêncios de uma maneira organizada. Vamos explicar: um ruído de rádio emite sons, mas não de uma forma organizada, por isso não é classificado como música. Essa definição parece simples e completa, mas definir música não é algo tão óbvio assim. Podemos classificar um alarme de carro como música? Ele emite sons e silêncios de uma maneira organizada, mas garanto que a maioria das pessoas não chamaria esse som de música."/>
      ...
      { openEncerramento && 
        <Modal 
          ...
          inputs
          buttons={[
            <Button handleClick={changeOpenEncerramento}>
              <AiOutlineArrowLeft />
              Voltar
            </Button>,
            <Button variant="outline" color="alert" handleClick={changeOpenPassword}>
              Encerrar
            </Button>
          ]}
        />
      ...
      { openPassword && 
        <Modal 
          ...
          buttons={[
            <Button handleClick={changeOpenPassword}>
              <AiOutlineArrowLeft />
              Voltar
            </Button>,
