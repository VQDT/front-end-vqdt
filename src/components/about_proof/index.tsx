  ...
  return (
    <div className=" flex flex-col w-full max-w-[1200px] bg-white h-[760px] rounded-[10px] p-8">
      ...
      <div className="mb-[50px]">
        <h2 className="font-bold text-primary mb-10 text-[20px]">Sobre a prova</h2>
      ...
      <div className="flex mb-[150px] ">
        <div className="whitespace-normal w-[50%] mr-10 ">
          <h3 className="text-primary font-bold text-[20px] mb-3">Local de aplicação da prova </h3>
        ...
        <div className='w-[50%] mb-[]'>
          <h3 className="text-primary font-bold mb-3 text-[20px]">Conteúdo da prova</h3>
      ...
      <div className="flex gap-[400px]">
        <Button variant="alert">Cancelar Agendamento</Button>
